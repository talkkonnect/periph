...
import (
	...
	"github.com/talkkonnect/periph/x/periph"
	"github.com/talkkonnect/periph/x/periph/conn/gpio"
	"github.com/talkkonnect/periph/x/periph/conn/gpio/gpioreg"
	"github.com/talkkonnect/periph/x/periph/conn/gpio/gpiostream"
	"github.com/talkkonnect/periph/x/periph/conn/physic"
	"github.com/talkkonnect/periph/x/periph/conn/pin"
	"github.com/talkkonnect/periph/x/periph/host/distro"
	"github.com/talkkonnect/periph/x/periph/host/pmem"
	"github.com/talkkonnect/periph/x/periph/host/sysfs"
	"github.com/talkkonnect/periph/x/periph/host/videocore"
)
...
func setSpeed(f physic.Frequency) error {
	...
	*/
	return errors.New("bcm283x: to change the I²C bus speed, please refer to https://periph/platform/raspberrypi/#i²c")
}
