...
import (
	...
	"periph/x/periph/conn/gpio"
	"periph/x/periph/conn/gpio/gpiostream"
	"periph/x/periph/conn/i2c"
	"periph/x/periph/conn/physic"
	"periph/x/periph/conn/pin"
	"periph/x/periph/conn/spi"
	"periph/x/periph/conn/uart"
	"periph/x/periph/host/pmem"
	"periph/x/periph/host/videocore"
)
