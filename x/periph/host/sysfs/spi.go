...
import (
	...
	"github.com/talkkonnect/periph/x/periph/conn"
...
//
// It is recommended to use https://periph/x/periph/conn/spi/spireg#Open
// instead of using NewSPI() directly as the package sysfs is providing a
// Linux-specific implementation. periph works on many OSes! This permits
